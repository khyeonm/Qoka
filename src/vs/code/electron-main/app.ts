...
/**
 * The main Qoka application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting Qoka');
		...
		// "com.microsoft.", which breaks native tabs for Qoka when using this
