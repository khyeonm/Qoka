 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Qoka UI).
 */
 ...
 * to represent terminals that appear in other parts of the Qoka UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Qoka OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given Qoka log level.
	 */
	updateLogLevel(): void;
