...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Aria in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Aria and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
