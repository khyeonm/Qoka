...
/**
 * Allows webviews to monitor when an element in the Aria editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Aria needs to see this
