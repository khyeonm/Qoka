...
/**
 * Allows webviews to monitor when an element in the Qoka editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Qoka needs to see this
