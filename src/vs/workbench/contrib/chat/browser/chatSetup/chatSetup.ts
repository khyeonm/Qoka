...
/**
 * Builds a redirect URL that GitHub will use to return the user to Qoka
 ...
 * @param urlProtocol The Qoka URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).
