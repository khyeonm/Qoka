...
type ScreenshotCapturedClassification = {
	...
	// Conversion factors
	windowZoomFactor: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Qoka per-window zoom factor for the hosting window (undefined if no editor currently holds the browser view).' };
	...
	// Window metadata
	windowInnerWidth: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Inner width of the hosting Qoka window viewport, in workbench CSS pixels (window.innerWidth). Undefined if no editor currently holds the browser view.' };
	windowInnerHeight: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Inner height of the hosting Qoka window viewport, in workbench CSS pixels (window.innerHeight). Undefined if no editor currently holds the browser view.' };
	isInAuxiliaryWindow: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Whether the browser view was hosted in a Qoka auxiliary window at capture time (undefined if no editor currently holds the browser view).' };
	...
	// Screen metadata
	screenWidth: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Width of the screen the hosting Qoka window is on, in OS-level CSS pixels (window.screen.width, unaffected by windowZoomFactor). Undefined if no editor currently holds the browser view.' };
	screenHeight: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Height of the screen the hosting Qoka window is on, in OS-level CSS pixels (window.screen.height, unaffected by windowZoomFactor). Undefined if no editor currently holds the browser view.' };
