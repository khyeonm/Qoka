...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often Qoka updates have failed.';
};
...
export abstract class AbstractUpdateService implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when Qoka detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of Qoka.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of Qoka.' };
