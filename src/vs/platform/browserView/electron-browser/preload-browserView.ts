...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* Qoka injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* Qoka injected style */ * { cursor: crosshair !important; }';
