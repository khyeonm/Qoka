...
/** Local session type — in-process Qoka chat, no background agent or worktree. */
...
/** Setting key controlling whether Local Qoka chat sessions are available in the Agents app. */
