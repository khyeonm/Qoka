...
const SERVER_INSTRUCTIONS = [
	...
	'6. Then offer the next step: propose building a runnable pipeline with autopipe ("Shall we build a',
	'   pipeline with autopipe next?"). If they agree, continue with the autopipe tools.',
	'',
