...
const SERVER_INSTRUCTIONS = [
	...
	'  save_papers for SEVERAL at once - do not loop save_paper; list_saved_papers). Read a paper, handle',
	'  citations, write or revise a manuscript -> the paper MCP tools.',
