...
const QOKA_BLOCK = [
	...
	'  SAVE, `search_project_memory` / `project_memory_index` to recall). Do NOT just say you will remember and',
	'  rely on your own memory - it does NOT persist across sessions in Qoka; the fact is only kept if you call',
	'  the tool.',
	'',
