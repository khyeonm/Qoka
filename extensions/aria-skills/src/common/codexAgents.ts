...
const QOKA_BLOCK = [
	...
	'  decision/fact for later, or recall earlier context -> the memory MCP tools (`remember_project_memory` to',
	'  SAVE, `search_project_memory` / `project_memory_index` to recall). ALWAYS write the memory in ENGLISH,',
	'  regardless of the conversation language. Do NOT just say you will remember and rely on your own memory -',
	'  it does NOT persist across sessions in Qoka; the fact is only kept if you call the tool.',
	'',
