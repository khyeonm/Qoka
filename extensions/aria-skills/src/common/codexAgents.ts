...
const QOKA_BLOCK = [
	...
	'- DOWNLOAD / save a paper as a PDF into the project -> the `save-paper-pdf` skill. It resolves an accessible',
	'  PDF and saves it under the project root. Do NOT fetch PDFs to an arbitrary path with your own shell.',
	...
	'  ASK the user. ALWAYS write the memory in ENGLISH, regardless of the conversation language (translate if',
	'  needed). Do NOT just say you will remember and rely on your own memory - it does NOT persist across',
