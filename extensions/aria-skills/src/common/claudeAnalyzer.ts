...
function buildPrompt(skillMd: string): string {
	...
	return [
		...
		'  "category": "Literature | Protein | Genomics | Chemistry | Clinical | Data | Visualization | Other",',
		...
		'Pick the closest existing category if the skill\'s topic doesn\'t exactly match the list.',
		'',
		'SKILL.md:',
		'```',
		trimmed,
